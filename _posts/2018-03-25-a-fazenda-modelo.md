...
<img src="{{ '/assets/img/fazenda-modelo.jpg' | relative_url }}" alt="Estrada de terra levando aos galpões de telha da Fazenda Modelo, com silo ao fundo, em Pedro Leopoldo.">
...
É de um desses diálogos, na reunião de 3 de agosto de 1949, que vem o relato sobre o amparo de Paulo de Tarso a Emmanuel, assunto de <a href="{{ '/2018/03/paulo-o-mentor-de-emmanuel/' | relative_url }}">Paulo, o mentor de Emmanuel</a>.
...
<p class="datacao">Publicado originalmente em 25 de março de 2018, no blog anterior.</p>
