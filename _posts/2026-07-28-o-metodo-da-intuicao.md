...
> [...]
>
> Assim, uso a música como outro meio inicial de sintonização de ambiente, a fim de que me ajude a saltar da harmonização nesse primeiro plano sensório exterior, para minha harmonização nos mais altos planos supersensórios; essa música obtenho através do rádio e do disco, especialmente a melhor música sinfônica, tipo Wagner, Beethoven, Bach, Chopin e outros.
>
> [...]
>
...
Este trecho é a oficina de *A Grande Síntese*.

A recepção que Ubaldi anatomiza no capítulo II é a daquela obra, recebida ao longo de quatro verões, de 1932 a 1935. Não é relato de experiência avulsa: é a descrição do processo que produziu um livro, e o livro está aí, inteiro, para quem quiser conferir.

Chama atenção a concretude do caminho. Ele começa pelo mobiliário. A hora do relógio, a intensidade da luz, o disco que está tocando, a sala que ele saturou das próprias vibrações de tanto pensar dentro dela. Só depois vem a visão, e da visão ele diz que não sabe dizer mais. Descreve o indizível como indizível e todo o resto como procedimento, com o cuidado de quem espera ser conferido.

Vale reparar no que ele chama de harmonização, porque não é técnica de concentração. É afinação moral. Num dos parágrafos que ficaram de fora deste recorte ele escreve que "não se pode imaginar o poder de harmonização que emana de um ato de bondade", e que "para conquistar o conhecimento, devo alcançar um estado de purificação". A condição de subir é a mesma coisa que a condição de melhorar. Daí a frase que grifei, que de outro modo pareceria só bonita: a ciência é um cântico e uma oração.

Adiante no capítulo ele dá nome ao que está fazendo. Chama de método da intuição, e o propõe como mais poderoso que o indutivo-experimental: o método interior da visão contra o método exterior da observação. O que se lê aqui é esse método em operação, antes de receber o nome.

E é ali também que ele encara de frente a pergunta que {% assign flam = site.posts | where_exp: "p", "p.title contains 'Flammarion'" | first %}{% if flam %}[Camille Flammarion]({{ flam.url | relative_url }}){% else %}Camille Flammarion{% endif %} fez a si mesmo: o escrito excede o que o escritor tinha condição de produzir? "Se o escrito supera a potência cultural e intelectiva do escritor, deve existir em algum lugar uma fonte que a tudo isso deu origem." É o mesmo teste, aplicado por dois médiuns à própria obra, com respostas opostas. Flammarion olhou para a "Uranografia" e não achou nada que o rapaz de dezenove anos já não soubesse. Ubaldi aponta para *A Grande Síntese* e diz o contrário. Nos dois casos o texto está publicado, o que quer dizer que a conta pode ser refeita.

E fica o fim, que é a parte que menos costuma ser citada. Ele volta, o céu se fecha, e ele está sozinho na realidade onde os outros têm razão e não ele.

<p class="datacao">Trecho do capítulo II de <em>As Noúres</em>, de Pietro Ubaldi, na tradução de Clóvis Tavares (5ª ed., Fraternidade Francisco de Assis / Instituto Pietro Ubaldi, 2001), reproduzido para fim de comentário, nos termos do art. 46, III, da Lei 9.610/98. Os cortes estão marcados com <code>[...]</code>. Os dois grifos em negrito são meus.</p>
